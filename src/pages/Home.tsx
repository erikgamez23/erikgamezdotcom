...
const Home = () => {
    return (
        ...
        <Section title="About Me" body="I'm based in Chicago. I like riding my bike around, taking pictures on my Fuji, and eating all foods. I'm a software engineer specializing in iOS development, and love tinkering with my computers at home!" imageSrc={erikPhoto} side="left" />
